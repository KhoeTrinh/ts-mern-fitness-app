...
const ContactUs = ({ SSP }: Props) => {
    ...
    return (
        ...
        >
            <motion.div
                onViewportEnter={() => SSP(SelectedPage.ContactUs)}
            >
                <motion.div
                    className='md:w-3/5'
                    initial='hidden'
                ...
                >
                    ...
                    <p className='my-5'>
                        ...
                        in feugiat nisl sapien vel rhoncus. Placerat at in
                        enim pellentesque. Nulla adipiscing leo egestas
                ...
                <div className='mt-10 justify-center gap-8 md:flex'>
                    ...
                    >
                        <form
                            ...
                            action='https://formsubmit.co/b5e5b0e3525eb40f0e577c021f2cc943'
                            method='POST'
                        >
                            <input
                                type='text'
