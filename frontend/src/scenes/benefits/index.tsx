...
const Benefits = ({ SSP }: Props) => {
    return (
        <section
            id='benefits'
            className='mx-auto min-h-full w-5/6 py-20'
        >
            <motion.div onViewportEnter={() => SSP(SelectedPage.Benefits)}>
                <motion.div
                    ...
                    <div>
                        ...
                        <div>
                            <p className='my-5'>
                                ...
                                ultrices tellus. Ullamcorper arcu id
                                pretium sapien proin integer nisl. Felis
                                orci diam odio.
                            </p>
                            <p className='mb-5'>
